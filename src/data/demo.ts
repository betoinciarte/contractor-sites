...
export const galleryProjects = [
  { id: 1, title: 'Modern Driveway', category: 'Driveways', location: 'Dallas, TX' },
  { id: 2, title: 'Backyard Patio', category: 'Patios', location: 'Fort Worth, TX' },
  { id: 3, title: 'Stamped Pool Deck', category: 'Stamped Concrete', location: 'Arlington, TX' },
  { id: 4, title: 'Foundation Stabilization', category: 'Foundation Repair', location: 'Plano, TX' },
  { id: 5, title: 'Front Walkway', category: 'Sidewalks', location: 'Irving, TX' },
  { id: 6, title: 'Extended Driveway', category: 'Driveways', location: 'Dallas, TX' },
  { id: 7, title: 'Covered Patio', category: 'Patios', location: 'Plano, TX' },
  { id: 8, title: 'Decorative Entry', category: 'Stamped Concrete', location: 'Fort Worth, TX' },
  { id: 9, title: 'Leveled Garage Floor', category: 'Concrete Leveling', location: 'Arlington, TX' },
];
