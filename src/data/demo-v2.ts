...
export const services = [
  {
    ...
    price: 'From $3,500',
    priceDetail: 'Typical 2-car driveway: $3,500–$7,000',
    image: `${IMG}/b1-portfolio-concrete-driveway-broom.webp`,
    longDesc: 'A new driveway adds curb appeal and up to $15,000 in home value. Ours are built to handle Texas heat, heavy trucks, and 20+ years of daily use without cracking. Every project starts with proper grading and a reinforced base — so it stays level and looking great for decades.',
    faqs: [
  ...
  },
  {
    ...
    price: 'From $4,000',
    priceDetail: 'Standard patio: $4,000–$8,000',
    image: `${IMG}/b1-portfolio-concrete-patio.webp`,
    longDesc: 'Turn your backyard into the space you actually want to spend time in. A well-built patio extends your living area, adds value to your home, and gives you a place to host, relax, or watch the kids play — for decades. From simple slabs to stamped designs with built-in seating and fire pit pads.',
    faqs: [
  ...
  },
  {
    ...
    longDesc: 'Foundation problems don\'t fix themselves — they get worse and more expensive every month you wait. We diagnose the real issue (not just the symptoms), fix it with industry-leading pier systems, and give you a transferable warranty. Your home feels solid again, and your peace of mind comes back.',
    faqs: [
  ...
  },
  {
    ...
    price: 'From $6,000',
    priceDetail: 'Typical project: $6,000–$12,000',
...
export const reviews = [
  ...
  { text: "Cracks started closing — I walked around pointing at walls in disbelief. My house feels solid again. Peace of mind you can't put a price on.", name: "David R.", location: "Plano, TX", service: "Foundation Repair" },
];

// V2: Improved stats — replaced confusing percentages with clearer metrics
export const stats = { years: 15, projects: 50, rating: 4.9, satisfaction: 100 };

export const statCards = [
  { target: 750, suffix: '+', label: 'Google Reviews' },
  { target: 42, suffix: '%', label: 'Name Our Crew' },
  { target: 21, suffix: '%', label: 'Praise Cleanup' },
  { target: 4.9, suffix: '★', label: 'Google Rating', decimal: true },
];
...
export const galleryProjects = [
  { id: 1, title: 'Broom-Finish Driveway', category: 'Driveways', location: 'Dallas, TX', image: `${IMG}/b1-portfolio-concrete-driveway-broom.webp`, cost: '$4,200', timeline: '3 days' },
  { id: 2, title: 'Backyard Patio', category: 'Patios', location: 'Fort Worth, TX', image: `${IMG}/b1-portfolio-concrete-patio.webp`, cost: '$5,800', timeline: '4 days' },
  { id: 3, title: 'Stamped Driveway', category: 'Stamped Concrete', location: 'Arlington, TX', image: `${IMG}/b1-portfolio-concrete-driveway-stamped.webp`, cost: '$8,500', timeline: '5 days' },
  { id: 4, title: 'Retaining Wall', category: 'Foundation Repair', location: 'Plano, TX', image: `${IMG}/b1-portfolio-concrete-retaining-wall.webp`, cost: '$6,200', timeline: '4 days' },
  { id: 5, title: 'Front Walkway', category: 'Sidewalks', location: 'Irving, TX', image: `${IMG}/b1-portfolio-concrete-sidewalk.webp`, cost: '$2,800', timeline: '2 days' },
  { id: 6, title: 'Stamped Entry', category: 'Stamped Concrete', location: 'Dallas, TX', image: `${IMG}/b1-portfolio-concrete-driveway-stamped.webp`, cost: '$7,100', timeline: '4 days' },
  { id: 7, title: 'Extended Patio', category: 'Patios', location: 'Plano, TX', image: `${IMG}/b1-portfolio-concrete-patio.webp`, cost: '$6,500', timeline: '4 days' },
  { id: 8, title: 'New Driveway Pour', category: 'Driveways', location: 'Fort Worth, TX', image: `${IMG}/b1-portfolio-concrete-driveway-broom.webp`, cost: '$5,100', timeline: '3 days' },
  { id: 9, title: 'Sidewalk Replacement', category: 'Concrete Leveling', location: 'Arlington, TX', image: `${IMG}/b1-portfolio-concrete-sidewalk.webp`, cost: '$1,200', timeline: '1 day' },
];

export const badges = [
  { src: '/images/badges/badge-5-star.webp', alt: '5-Star Rated' },
  { src: '/images/badges/badge-licensed-insured.webp', alt: 'Licensed & Insured' },
  { src: '/images/badges/badge-satisfaction.webp', alt: '100% Satisfaction Guaranteed' },
